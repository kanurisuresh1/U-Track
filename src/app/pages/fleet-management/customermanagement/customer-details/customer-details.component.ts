...
import { CustomerManagementDetails, CustomerManagementListDetails, CustomersDetails } from '../../../../@theme/components/Model/CustomerManagementDetails';
...
export class CustomerDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.headerService.updateHeaderTitle('Customer Details');
