...
@NgModule({
  declarations: [PurchasesComponent, BuyPlansComponent, BuyProductsComponent, MyOrdersComponent, PurchasedPlanHistoryComponent, PlanDetailsComponent, PurchasedPlanDetailsComponent, ProductDetailsComponent],
  imports: [
    CommonModule,
