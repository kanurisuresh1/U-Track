...
@NgModule({
  declarations: [MyaccountComponent, MyProfileComponent, MyWalletComponent, MyTripsComponent, MyGeofenceComponent, MyRoutesComponent, MySharedUsersComponent, MyDriversComponent, MyGroupsComponent, CreateGroupComponent, EditGroupComponent,],
  imports: [
    CommonModule,
